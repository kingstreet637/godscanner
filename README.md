...
### 3. **Running Godscanner**
Once you have downloaded the software, follow these steps to run it:

1. Locate the downloaded file in your computer's Downloads folder.
2. Double-click the file to open it. You may be prompted with security warnings; choose to open it if you trust the source.
...
Once the scan is complete, you will see the results displayed on your screen. Here’s how to read them:
...
- **Problem:** The scan returns no results.
